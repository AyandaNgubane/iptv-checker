        ...
        <nav className={styles.headerNav}>
          {(['xtream','stalker','channels','history','debug','base64'] as Tab[]).map(t => (
            <button key={t} className={`${styles.navBtn} ${tab === t ? styles.navBtnActive : ''}`} onClick={() => setTab(t)}>
              ...
              {t === 'xtream' ? 'Xtream Codes' : t === 'stalker' ? 'Portal Stalker' : t === 'channels' ? 'Channel Finder' : t === 'history' ? 'History' : t === 'xtream' ? 'Xtream Codes' : t === 'stalker' ? 'Portal Stalker' : t === 'channels' ? 'Channel Finder' : t === 'history' ? 'History' : t === 'debug' ? 'Debug' : t === 'base64' ? 'Base64' : 'Player'}
            </button>
          ))}
        </nav>
      </header>
